...
var ControlBar = React.createClass({displayName: "ControlBar",
  ...
  populateControlBar: function() {
    ...
    var controlItemTemplates = {
      ...
      "toggleSpeed": React.createElement("a", {className: "oo-toggle-speed oo-control-bar-item", onClick: this.handleToggleSpeed, key: "toggleSpeed"}, 
    ...
    for (var k = 0; k < collapsedControlBarItems.length; k++) {
      ...
      console.log('\tcontrolItemTemplates[' + collapsedControlBarItems[k].name + '])');
...
OO.plugin("Html5Skin", function (OO, _, $, W) {
  ...
  if (OO.publicApi && OO.publicApi.VERSION) {
    ...
    OO.publicApi.VERSION.skin = {"releaseVersion": "4.7.7", "rev": "745c113ef921bed27e5868b83432d3dbb84bae63"};
  }
